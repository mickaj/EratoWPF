EratoWPF is an x64 application to find all prime numbers in given range. To achieve that it uses an algorithm based on Sieve of Eratosthenes (see Wikipedia).
